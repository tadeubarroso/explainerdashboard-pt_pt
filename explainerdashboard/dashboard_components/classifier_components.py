                    ...
                    dbc.CardHeader(
                        [
                            html.Div(
                                [
                                    html.H3(
                                        f"Selecionar {self.explainer.index_name}",
...
class PrecisionComponent(ExplainerComponent):
    ...
    def __init__(
        self,
        explainer,
        title="Gráfico de Precisão",
        name=None,
        subtitle="A fração de positivos aumenta com a probabilidade prevista?",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_cutoff=False,
...
class ConfusionMatrixComponent(ExplainerComponent):
    ...
    def __init__(
        ...
        name=None,
        subtitle="Quantos falsos positivos e falsos negativos?",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_cutoff=False,
...
class LiftCurveComponent(ExplainerComponent):
    ...
    def __init__(
        ...
        title="Curva Lift",
        name=None,
        subtitle="Desempenho quanto melhor que aleatório?",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_cutoff=False,
...
class CumulativePrecisionComponent(ExplainerComponent):
    ...
    def __init__(
        self,
        explainer,
        title="Precisão Cumulativa",
        name=None,
        subtitle="Distribuição esperada para as pontuações mais altas",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_selector=False,
...
class ClassificationComponent(ExplainerComponent):
    ...
    def __init__(
        self,
        explainer,
        title="Gráfico de Classificação",
        name=None,
        subtitle="Distribuição dos rótulos acima e abaixo do limite (cutoff)",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_cutoff=False,
...
class RocAucComponent(ExplainerComponent):
    ...
    def __init__(
        self,
        explainer,
        title="Gráfico ROC AUC",
        name=None,
        subtitle="Compromisso entre Falsos Positivos e Taxa de Verdadeiros Positivos",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_cutoff=False,
...
class PrAucComponent(ExplainerComponent):
    ...
    def __init__(
        self,
        explainer,
        title="Gráfico PR AUC",
        name=None,
        subtitle="Compromisso entre Precisão e Recall",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_cutoff=False,
...
class ClassifierModelSummaryComponent(ExplainerComponent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.description is None:
            self.description = """
        tra uma lista de várias métricas de desempenho para o modelo.
                            ...
                            make_hideable(
                                html.Div(
                                    [
                                        ...
                                        dbc.Tooltip(
                                            f"Pontuações acima deste limiar serão classificadas como positivas.",
